...
function HomePage({addToFavorites, IsLoggedIn, setIsLoggedIn}) {
  ...
  return (
    <div className="md:px-2 bg-gray-50 md:bg-transparent">
      ...
      {/* for DesTop */}
      <div
        className={`hidden md:block w-full max-w-[100%] md:py-2 bg-white dark:bg-[#1a1a1a] ${
          isScrolled
            ? "fixed right-0 top-0 left-0 mt-0 z-40"
            : "relative mt-0 md:mt-1"
        }`}
      >
        <div className="div1 bg-white relative w-full md:border  dark:bg-[#1a1a1a] md:border-cyan-200 h-auto rounded-md dark:border-cyan-300">
          <div className="w-full md:h-auto md:bg-transparent flex flex-col md:flex-row justify-between p-2 gap-2">
            <div className="w-full md:w-[70%] px-3 md:px-0">
              <input
                ...
                className="w-full dark:bg-[#282828] h-9 px-3 py-2 md:py-1 rounded-full md:rounded-md outline-none shadow-[0px_0px_3px_rgba(0,0,0,0.1)] text-sm focus:ring-1 focus:ring-cyan-500 md:mt-0 border border-gray-400 md:border-none"
          ...
          <div className="button mt-2.5 flex flex-wrap items-center gap-2.5 pb-2 px-2">
            <button
              onClick={() => setSelectedCategory("categoryImageAnimals")}
              className="px-3 gap-2.5 rounded-full border dark:text-white transition-colors duration-200 hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 flex items-center text-xs outline-none h-8 shadow-md"
            >
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/7968acd8-743b-44c8-aaff-e7f9896125e3_thumbnail.png"
                alt="button image"
              />
              {t("home.categoryImageAnimals")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageFood")}
              className="px-3 gap-2.5 border rounded-full transition-colors duration-200 dark:text-white flex items-center text-xs outline-none h-8 shadow-md hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              {" "}
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/f8106745-1da2-4be8-a530-84082d194ca3_thumbnail.png"
                alt="button image"
              />{" "}
              {t("home.categoryImageFood")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageClothing")}
              className="px-3 py-2 rounded-full border transition-colors duration-200 dark:text-white flex items-center text-xs outline-none h-8 shadow-md gap-2.5 hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              {" "}
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/9d6a5ef0-522c-4616-9de0-c9d27f40eb3e_thumbnail.png"
                alt="button image"
              />{" "}
              {t("home.categoryImageClothing")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageServices")}
              className="px-3 py-2 rounded-full border transition-colors duration-200 dark:text-white flex items-center text-xs outline-none h-8 shadow-md gap-2.5 hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              {" "}
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/0a43ce1b-08a5-4bd1-9b1c-3b93a5e6c520_thumbnail.png"
                alt="button image"
              />
              {t("home.categoryImageServices")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageMachinery")}
              className="px-3 py-2 rounded-full border flex items-center text-xs outline-none h-8 shadow-md gap-2.5 transition-colors duration-200 dark:text-white hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/f921fee2-ec04-4b29-9a02-308de408a493_thumbnail.png"
                alt="button image"
              />{" "}
              {t("home.categoryImageMachinery")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageHomeAppliances")}
              className="px-3 py-2 rounded-full border flex items-center text-xs outline-none h-8 shadow-md gap-2.5 transition-colors duration-200 dark:text-white hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/50b9c231-2cec-4b3b-b551-86c1af9bf145_thumbnail.png"
                alt="button image"
              />{" "}
              {t("home.categoryImageHomeAppliances")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageVehicles")}
              className="px-3 py-2 rounded-full border flex items-center text-xs outline-none h-8 shadow-md gap-2.5 transition-colors duration-200 ] dark:text-white hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/e802a9db-5d0c-4dbf-9424-ef7d26a02cb4_thumbnail.png"
                alt="button image"
              />
              {t("home.categoryImageVehicles")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageMobiles")}
              className="px-3 py-2 rounded-full border flex items-center text-xs outline-none h-8 shadow-md gap-2.5 transition-colors duration-200 dark:text-white hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/f8fda21c-0070-4206-8a03-80f8dc354586_thumbnail.png"
                alt="button image"
              />
              {t("home.categoryImageMobiles")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageJobs")}
              className="px-3 py-2 rounded-full border flex items-center text-xs outline-none h-8 shadow-md gap-2.5 transition-colors duration-200 dark:text-white hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/06bbd819-43b0-4ded-8a71-98b01cd31763_thumbnail.png"
                alt="button image"
              />
              {t("home.categoryImageJobs")}
            </button>
            <button
              onClick={() => setSelectedCategory("categoryImageRealEstate")}
              className="px-3 py-2 rounded-full border flex items-center text-xs outline-none h-8 shadow-md gap-2.5 transition-colors duration-200 dark:text-white hover:text-cyan-700 dark:border-cyan-300 border-cyan-200 hover:bg-cyan-100 dark:hover:bg-cyan-900 "
            >
              <img
                className="w-4 h-4 rounded-full object-cover"
                src="https://ganjyab.s3.eu-north-1.amazonaws.com/7510bd16-e538-42ff-a90a-ad96f33565f2_thumbnail.png"
                alt="button image"
              />
      ...
      {/* for Mobile */}
      <div
        className={`w-full md:hidden max-w-[100%]  bg-white dark:bg-[#1a1a1a] relative`}
      >
        <div className="  relative w-full  dark:bg-[#1a1a1a] h-[184px] bg-white rounded-md dark:border-cyan-300">
            ...
            <div className="w-full h-[100px] bg-white dark:bg-[#282828]">
              <div className="flex space-x-3 pl-4">
                <button
                  ...
                  className={`px-4 py-1 border border-gray-400 rounded-md outline-none flex items-center justify-between ${
                    selectedProvince ||
                ...
                >
                  ...
                  {(selectedProvince ||
                    ...
                    <span
                      ...
                      className="ml-2 text-orange-600 cursor-pointer"
                    >
                ...
                <button
                  ...
                  className={`px-4 py-1 border border-gray-400 rounded-md outline-none flex justify-between items-center ${
                    selectedProvince || selectedDistricts.length > 0
                      ? "bg-cyan-500"
                      : ""
                  }`}
                >
          ...
          {area && (
            <SelecProvince onClose={() => setArea(false)} showClass="flex" />
          )}
          {category && (
            <Category
              isOpen={category}
      ...
      <div className="relative bg-gray-50 md:bg-transparent  w-full dark:bg-[#1a1a1a]">
        {filteredProducts.length > 0 ? (
          ...
          <div className="w-full min-h-[105vh] flex items-center justify-center">
            <div className="h-auto flex flex-col items-center shadow-lg bg-white dark:bg-[#282828] p-6 rounded-md mx-auto">
              ...
              <p className="text-gray-700 dark:text-gray-300 font-semibold text-xl mb-2">
                No items found.
              </p>
        ...
        {selectedProduct && (
          <ContactModal
            ...
            phone={selectedProduct.phoneNumber}
            whatsapp={selectedProduct.whatsappNumber}
