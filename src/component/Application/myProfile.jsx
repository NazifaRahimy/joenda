    ...
    return (
        <div className="w-full pb-20 ">
            ...
            <div className="relative px-4 pt-1 pb-4 w-full bg-gray-100  dark:bg-[#121212]  overflow-y-auto ">
                {user && (
                    <div className="user flex mt-3 justify-start items-center gap-4 px-3 mb-5">
                        <div className="imageProfile flex items-center justify-center w-[60px] h-[60px] border bg-cyan-600 border-gray-400 rounded-full"><FiUser size={20}/> {user.image} </div>
                ...
                <div className="w-full px-3 py-2 flex flex-col bg-white dark:bg-[#232323] shadow rounded mt-2 ">
                    <button onClick={() => setTheme(theme === "day" ? "night" : "day")} className="border-b p-1 pb-2 border-gray-400 flex justify-between items-center gap-2" >
                        <span className="flex gap-3 text-[#282828] dark:text-white text-[16px] tracking-wide  "><MdOutlineNightlight size={25} className="-rotate-45" /> Dark Mode</span>
            ...
            <div className="login px-4 py-2 border-black flex justify-between dark:bg-[#232323] items-center gap-2 bg-white mt-4 rounded">
                <span className="text-[#282828] dark:text-white mt-1 text-[16px]">version</span>
